  ...
  return (
    <footer className="w-full pt-20 pb-10 relative" id="contact">
      ...
      <div className="flex flex-col items-center text-center px-4">
        ...
        <a href="mailto:manishkt52@gmail.com">
          <MagicButton
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center gap-6 px-6">
        <p className="md:text-base text-sm md:font-normal font-light">
          Copyright © 2026 Manish Kumar Toppo
        </p>
        ...
        <div className="flex items-center md:gap-3 gap-6">
          {socialMedia.map((info) => (
            <a
              ...
              className="w-10 h-10 flex justify-center items-center backdrop-blur-lg bg-black-200 border border-black-300 rounded-lg hover:scale-110 hover:bg-purple transition-all duration-300"
            >
